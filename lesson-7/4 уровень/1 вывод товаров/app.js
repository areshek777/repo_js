...
buttonEl.forEach(function(buttonClick) {
	buttonClick.addEventListener('click', function(event){
	clickHandler(event.target.dataset.type);
})
})
/**
...
function showCategory(category) {
    ...
    let markupGeneration = '';
	product.forEach(function(product) {
		markupGeneration += getProductMarkup(product);
	})
	productsEl.insertAdjacentHTML('afterbegin', markupGeneration) 
